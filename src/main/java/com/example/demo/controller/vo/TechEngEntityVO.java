...
@Entity
@Table(name = "TechEng", schema = "technology", catalog = "")
public class TechEngEntityVO implements Serializable{
    private String no;
    ...
    @Basic
    @Column(name = "Fields", nullable = true, length = 255)
    ...
    @Basic
    @Column(name = "Highlights", nullable = true, length = 255)
...
//
//        TechEngEntityVO that = (TechEngEntityVO) o;
//
...
//        if (stability != znull ? !stability.equals(that.stability) : that.stability != null) return false;
